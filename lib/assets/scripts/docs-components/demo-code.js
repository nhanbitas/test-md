...
// import font after highlight to generate icon
document.addEventListener('DOMContentLoaded', () => {
  const addScript = (src) => {
  ...
  addScript('../../lib/third-party/font-awesome/fontawesome.min.js?v=0.5.231106a')
  addScript('../../lib/third-party/font-awesome/regular.js?v=0.5.231106a')
});
